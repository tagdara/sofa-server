...
class code:
  ...
  CONTROLLERCONFIG_QUERY = 12532
  CONTROLLERCONFIG_ANSWER = CONTROLLERCONFIG_QUERY + 1
  BUTTONPRESS_QUERY = 12530
  BUTTONPRESS_ANSWER =  12531
  COLORLIGHTSCOMMAND_QUERY = 12556
  COLORLIGHTSCOMMAND_ANSWER = 12557
